...
class Abonne(Base):
    ...
    trial_actif          = Column(Boolean, default=False)
    trial_expire_le      = Column(Date, nullable=True)
    plan_periode         = Column(String(20), default="mensuel")
    derniere_facture_id  = Column(String(100), nullable=True)
    nb_renouvellements   = Column(Integer, default=0)
    totp_secret          = Column(String(32), nullable=True)
    totp_active          = Column(Boolean, default=False)
